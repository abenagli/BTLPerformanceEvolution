...
def SetGraphStyle(graph, label):
    if label == '15 #mum cell size, 3x3mm^{2}':
        graph.SetMarkerStyle(20)
    if label == '15 #mum cell size, 2x2mm^{2}':
        graph.SetMarkerStyle(21)        
    if label == '15 #mum cell size, 1.4x1.4mm^{2}':
        graph.SetMarkerStyle(22)
        
infilenames = OrderedDict()
infilenames['15 #mum cell size, 3x3mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_final.root'
infilenames['15 #mum cell size, 2x2mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_2x2mm2_final.root'
infilenames['15 #mum cell size, 1.4x1.4mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_1.4x1.4mm2_final.root'

infilenames_up = OrderedDict()
infilenames_up['15 #mum cell size, 3x3mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_final.root'
infilenames_up['15 #mum cell size, 2x2mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_2x2mm2_final.root'
infilenames_up['15 #mum cell size, 1.4x1.4mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_1.4x1.4mm2_final.root'

infilenames_down = OrderedDict()
infilenames_down['15 #mum cell size, 3x3mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_final.root'
infilenames_down['15 #mum cell size, 2x2mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_2x2mm2_final.root'
infilenames_down['15 #mum cell size, 1.4x1.4mm^{2}'] = '../plots/outFile__LO1265_tau38.5__HPK_dropPDE0.22_dropGain0.08_TECs__noise420__Top_-45_Tann1_15_Tann2_40_interfillAnnealing__HLLHCSchedule81__maxPower800__15um_1.4x1.4mm2_final.root'

colors = {}
colors['15 #mum cell size, 3x3mm^{2}'] = 51
colors['15 #mum cell size, 2x2mm^{2}'] = 51+15
colors['15 #mum cell size, 1.4x1.4mm^{2}'] = 51+15+15
...
leg.AddEntry(graphsErr['15 #mum cell size, 3x3mm^{2}'],'%s'%'15 #mum cell size, 3.0#times3.0 mm^{2}','PF')
leg.AddEntry(graphsErr['15 #mum cell size, 2x2mm^{2}'],'%s'%'15 #mum cell size, 2.0#times2.0 mm^{2}','PF')
leg.AddEntry(graphsErr['15 #mum cell size, 1.4x1.4mm^{2}'],'%s'%'25 #mum cell size, 1.4#times1.4 mm^{2}','PF')

leg.Draw('same')

c.Print('c_tRes_vs_Vov_HGCalSiPMs.png')
